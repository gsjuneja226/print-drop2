...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="relative py-8 sm:py-16 lg:py-20 bg-[#08080C] overflow-hidden">
      {/* Background shapes */}
            ...
            {steps.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#0E0E16]/80 rounded-2xl p-3 sm:p-5 shadow-[0_4px_25px_rgba(0,0,0,0.25)] border border-white/5 border-l-4 border-l-[#4F46E5] flex flex-col justify-between hover:border-white/10 hover:shadow-[0_10px_30px_rgba(79,70,229,0.08)] hover:-translate-y-1 transition-all duration-300 group min-h-[145px] sm:min-h-0 lg:min-h-[200px]"
                >
                  <div className="space-y-3 sm:space-y-4">
                    {/* Circle Header & Icon */}
                    <div className="flex items-center justify-between">
                      <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#4F46E5]/15 border border-[#4F46E5]/30 flex items-center justify-center font-display font-bold text-[10px] sm:text-xs text-indigo-400 group-hover:bg-[#4F46E5] group-hover:text-white transition-all duration-300">
                        {step.number}
                      </div>
                      
                      <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-2xl bg-[#7C3AED]/5 border border-white/5 flex items-center justify-center text-[#7C3AED] group-hover:scale-110 transition-transform duration-300">
