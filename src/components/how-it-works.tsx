...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="relative py-24 bg-[#F8F9FF] overflow-hidden">
      {/* Background shapes */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[52px] left-[10%] right-[10%] h-0.5 border-t-2 border-dashed border-[#4F46E5]/20 z-0" />
            ...
            {steps.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(79,70,229,0.03)] border-l-4 border-[#4F46E5] flex flex-col justify-between hover:shadow-[0_10px_30px_rgba(79,70,229,0.07)] hover:-translate-y-1 transition-all duration-300 group min-h-[260px]"
                >
                  <div className="space-y-4">
                    {/* Circle Header & Icon */}
                    <div className="flex items-center justify-between">
                      <div className="w-10 h-10 rounded-full bg-[#4F46E5]/10 flex items-center justify-center font-display font-bold text-xs text-[#4F46E5] group-hover:bg-[#4F46E5] group-hover:text-white transition-all duration-300">
                        {step.number}
                      </div>
                      
                      <div className="w-12 h-12 rounded-2xl bg-[#7C3AED]/5 border border-[#7C3AED]/10 flex items-center justify-center text-[#7C3AED] group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-[#0F0F1A]/65 leading-relaxed font-medium">
                        {step.desc}
                      </p>
                    </div>
                  </div>
