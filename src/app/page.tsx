...
export default function MarketingLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F0F1A] select-none font-body antialiased">
      
      {/* HEADER NAVBAR */}
      <header className="border-b border-[#E5E7F0] bg-white/80 backdrop-blur-md sticky top-0 z-50 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => router.push('/')}>
            ...
            <span className="font-display font-bold text-lg tracking-wide text-[#0F0F1A]">
              PrintDrop
            </span>
          </div>

          {/* Nav Links */}
          <nav className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-wider text-[#0F0F1A]/70">
            <a href="#how-it-works" className="hover:text-[#4F46E5] transition-colors">How It Works</a>
            <a href="#features" className="hover:text-[#4F46E5] transition-colors">Platform Features</a>
          </nav>
